...
KERNEL_ARCH=arm64
KERNEL_DEFCONFIG=${KERNEL_DEFCONFIG:-bq_aquaris_m10_ubuntu_defconfig}
KERNEL_CROSS_COMPILE=${KERNEL_CROSS_COMPILE:-$(readlink -f "${KERNEL_DIR}/aarch64-linux-android-4.9")/bin/aarch64-linux-android-}

...
ifneq ($(strip $(TARGET_NO_KERNEL)),true)
  ...
  ifeq ($(wildcard $(TARGET_PREBUILT_KERNEL)),)
    ...
    KERNEL_MAKE_OPTION := O=$(KERNEL_OUT) ARCH=$(TARGET_ARCH) CROSS_COMPILE="$(if $(CC_WRAPPER),$(abspath $(CC_WRAPPER)) )$(KERNEL_CROSS_COMPILE)" ROOTDIR=$(KERNEL_ROOT_DIR) $(if $(strip $(SHOW_COMMANDS)),V=1)
